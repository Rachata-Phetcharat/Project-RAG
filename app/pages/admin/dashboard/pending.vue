        ...
        <div class="mb-8">
            ...
            <div class="flex items-center gap-3 mb-6">
                <div class="relative">
                    ...
                    <div class="rrelative p-3 bg-blue-500 dark:bg-blue-500 rounded-xl">
                        <UIcon name="i-lucide-clipboard-list" class="w-6 h-6 text-white dark:text-white" />
                    </div>
                </div>
                <div>
            ...
            <div v-else-if="!channels.length" class="relative">
                ...
                <div
                    ...
                    <div class="flex items-center gap-2 px-4 py-2 bg-green-100 dark:bg-green-900/30 rounded-full">
                        ...
                        <span class="text-sm font-medium text-green-700 dark:text-green-300">ทุกอย่างเรียบร้อย</span>
                    </div>
                </div>
            </div>
