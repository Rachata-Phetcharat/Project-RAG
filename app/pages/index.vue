...
<template>
    <div class="">
        ...
        <header class="mb-16 relative">
            <div
                class="absolute inset-0 bg-gradient-to-r from-blue-600/10 to-indigo-600/10 dark:from-blue-500/20 dark:to-indigo-500/20 rounded-3xl blur-3xl -z-10">
            </div>
            <div class="text-center md:text-left space-y-4">

                <h1 class="text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight">
                    <span
                        class="bg-gradient-to-r from-gray-900 to-gray-700 dark:from-white dark:to-gray-300 bg-clip-text text-transparent">
                        ยินดีต้อนรับสู่
                    </span>
                    <br />
                    <span
                ...
                <div v-else class="relative">
                    ...
                    <div
                        ...
                        <div class="relative mb-4">
                            <div
                                class="absolute inset-0 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-full blur-lg opacity-20 animate-pulse">
                            </div>
                            <div
                                class="relative p-4 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-full shadow-md border border-blue-100 dark:border-blue-800">
